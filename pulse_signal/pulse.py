...
def give_waveformInfo(beat,width,height)->dict:
    ...
    match waveform:
        ...
        case "gaussup":
            ...
            carrierPhase = 0
            func_paras = [height, width*2/sfactor, 0]
        ...
        case "gaussdn":
            ...
            carrierPhase = 0
            func_paras = [height, width*2/sfactor, width]


        case "drage":   # waveform with ErfGaussian
            pulse_func = cpf.DRAGFunc_ErfG
            if len(paraList)==1:
                sfactor = 4
                dRatio = 0.5
                rotAxis = 0
            ...
            func_paras = [height, width/sfactor, dRatio ]
        ...
        case "drag":
            ...
            carrierPhase = pi *(rotAxis/180.)
            func_paras = [height, width/sfactor, width/2, dRatio ]
